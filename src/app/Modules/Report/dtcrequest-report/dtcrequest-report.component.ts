...
export class DtcrequestReportComponent {
  ...
  newPDF() {
    ...
    const Tier1rows = [
      ...
      this.ProductDetail[0].Packaging_T1, this.Packaging_per, this.ProductDetail[0].Freight_T1, this.FreightLogistics_per, 0, this.Tariff_Per]
    ];
    ...
    if (!this.T2NotPresent) {
      ...
      const Tier2rows = [
        ...
        this.ProductDetail[0].Packaging_T2, this.Packaging_per_T2, this.ProductDetail[0].Freight_T2, this.FreightLogistics_per_T2, 0, this.Tariff_Per_T2]
      ];
    ...
    const headers = [['Idea', 'Potential Savings PP ($)']];
