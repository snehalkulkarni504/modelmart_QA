...
@Component({
  ...
  standalone: false,
  // imports: [],
  templateUrl: './designtocost-step1.component.html',
  styleUrl: './designtocost-step1.component.css'
})
export class DesigntocostStep1Component implements OnInit {
  ...
  constructor(private adminService: AdminService, public searchservice: SearchService,
    public designtocost: DesigntocostService,
