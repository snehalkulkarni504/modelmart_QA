...
@Component({
  selector: 'app-designtocost-step2',
  standalone: false,
  // imports: [],
  templateUrl: './designtocost-step2.component.html',
  styleUrl: './designtocost-step2.component.css'
})
export class DesigntocostStep2Component implements OnInit {
  ...
  async getShouldeCost(id: number) {
    try {
      ...
      localStorage.setItem("DTCCosttype", this.Costtype);
